                ...
                %>
                    <div class="department-card">
                        <div class="department-image">
                            ...
                            String imagePath = "/images/departments/" + deptName.replaceAll("\\s+", "-") + ".jpg";
                            %>
                            <img src="<%= request.getContextPath() + imagePath %>" alt="<%= dept.getName() %>" onerror="this.onerror=null; this.src='<%= request.getContextPath() %>/images/departments/default-department.jpg';">
