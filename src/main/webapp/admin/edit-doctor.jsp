...
<%
    ...
    String dateOfBirth = doctor.getDateOfBirth() != null ? dateFormat.format(doctor.getDateOfBirth()) : "";
%>
<!DOCTYPE html>
<html>
<head>
                ...
                <form action="<%= request.getContextPath() %>/admin/doctors/*" method="post">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control" value="<%= doctor.getName() != null ? doctor.getName() : "" %>" required>
                        </div>
                        <div class="form-group">
                            <label for="username">Username *</label>
                            <input type="text" id="username" name="username" class="form-control" value="<%= doctor.getUsername() != null ? doctor.getUsername() : "" %>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="email" id="email" name="email" class="form-control" value="<%= doctor.getEmail() != null ? doctor.getEmail() : "" %>" required>
                        </div>
                        <div class="form-group">
                            <label for="phone">Phone Number</label>
                            <input type="tel" id="phone" name="phone" class="form-control" value="<%= doctor.getPhone() != null ? doctor.getPhone() : "" %>">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select id="gender" name="gender" class="form-control">
                                ...
                                <option value="male" <%= "male".equals(doctor.getGender()) ? "selected" : "" %>>Male</option>
                                <option value="female" <%= "female".equals(doctor.getGender()) ? "selected" : "" %>>Female</option>
                                <option value="other" <%= "other".equals(doctor.getGender()) ? "selected" : "" %>>Other</option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select id="departmentId" name="departmentId" class="form-control">
                                ...
                                <% for (Department dept : departments) { %>
                                    <option value="<%= dept.getId() %>" <%= (departmentId != null && departmentId == dept.getId()) ? "selected" : "" %>><%= dept.getName() %></option>
                                <% } %>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        <a href="doctors.jsp" class="btn btn-outline">Cancel</a>
