...
// Get patient and appointment from request
...
<head>
    ...
    <title>Start Consultation - LifeCare Medical Center</title>
        ...
        <div class="dashboard-container">
            ...
            <div class="main-content">
                ...
                <div class="welcome-header">
                    <h1>
                        <c:choose>
                            <c:when test="${appointment.status eq 'In Progress' or appointment.status eq 'in progress'}">Continue Consultation</c:when>
                            <c:otherwise>Start Consultation</c:otherwise>
                        </c:choose>
                    </h1>
                    <p>Record consultation details for your patient.</p>
                </div>
                ...
                <div class="consultation-form">
                    ...
                    <c:if test="${empty patient || empty appointment}">
                        <p>Patient or appointment not found.</p>
                        <a href="appointments" class="btn">Back to Appointments</a>
                    </c:if>

                    <c:if test="${not empty patient && not empty appointment}">
                        ...
                        <form action="${pageContext.request.contextPath}/doctor/start-consultation" method="post">
                            <input type="hidden" name="appointmentId" value="${appointment.id}">
                            <input type="hidden" name="patientId" value="${patient.id}">

                            <div class="form-group">
                                <label for="diagnosis">Diagnosis</label>
                                <textarea id="diagnosis" name="diagnosis" class="form-control" rows="3" placeholder="Enter diagnosis details"></textarea>
                            </div>

                            <div class="form-group">
                                <label for="treatment">Treatment Plan</label>
                                <textarea id="treatment" name="treatment" class="form-control" rows="3" placeholder="Enter treatment plan"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <!-- Updated to match exact database values: 'Scheduled','In Progress','Completed','Cancelled' -->
                            </div>

                            <div class="form-actions">
                                <a href="appointments" class="btn btn-outline-primary">Cancel</a>
                                <button type="submit" class="btn">
                                    <c:choose>
                                        <c:when test="${appointment.status eq 'In Progress' or appointment.status eq 'in progress'}">Update Consultation</c:when>
                                        <c:otherwise>Complete Consultation</c:otherwise>
                                    </c:choose>
                                </button>
                            </div>
                        </form>
