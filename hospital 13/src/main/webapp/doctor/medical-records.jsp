...
<body>
                ...
                <div class="new-record-form">
                    ...
                    <form action="save-medical-record" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <button type="button" id="debug-btn" class="btn debug-btn">Debug Form</button>
                        </div>
                    </form>
                </div>
                <% } else { %>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Form validation for medical record form
            const medicalRecordForm = document.querySelector('form[action="save-medical-record"]');
            if (medicalRecordForm) {
                console.log('Medical record form found, adding validation');
                ...
                medicalRecordForm.addEventListener('submit', function(e) {
                    ...
                    if (recordType.value === '') {
                        ...
                        isValid = false;
                        recordType.classList.add('error');
                    } else {
                        recordType.classList.remove('error');
                    }

                    // Validate title
                    if (recordTitle.value.trim() === '') {
                        errorMessage += 'Please enter a title.\n';
                        isValid = false;
                        recordTitle.classList.add('error');
                    } else {
                        recordTitle.classList.remove('error');
                    }
                    ...
                    if (recordContent.value.trim() === '') {
                        ...
                        isValid = false;
                        recordContent.classList.add('error');
                    } else {
                        recordContent.classList.remove('error');
                    }
            ...
            if (debugBtn) {
                debugBtn.addEventListener('click', function() {
                    const form = document.querySelector('form[action="save-medical-record"]');
                    if (form) {
                        ...
                        // Test form submission with a hidden iframe
                        const testSubmit = confirm('Would you like to test form submission?');
                        if (testSubmit) {
                            ...
                            clonedForm.action = originalAction;
                            clonedForm.target = 'testFrame';
            ...
            if (urlParams.has('error')) {
                ...
                } else if (errorType === 'create-failed') {
                    errorMessage = 'Failed to create medical record. Please try again.';
                } else if (errorType === 'server-error') {
                    errorMessage = 'A server error occurred. Please try again later.';
                }

                // Only show alert if no error message is already displayed on the page
