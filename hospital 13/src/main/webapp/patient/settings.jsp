...
System.out.println("Attributes in patient/settings.jsp:");
...
<head>
    ...
    <title>Settings - LifeCare Medical Center</title>
        ...
        <div class="dashboard-container">
            ...
            <div class="main-content">
                ...
                <div class="settings-container">
                    ...
                    <form action="${pageContext.request.contextPath}/patient/settings" method="post">
                        <div class="form-group">
                            <label for="email">Email Address</label>
                            <input type="email" id="email" name="email" class="form-control" value="<%= username %>@example.com">
                        </div>
                        <div class="form-group">
                    ...
                    <form action="${pageContext.request.contextPath}/patient/settings" method="post">
                        <div class="settings-section">
                            ...
                            <div class="form-check">
                                <input type="checkbox" id="appointment-reminder" name="emailNotifications" checked>
                                <label for="appointment-reminder">Appointment Reminders</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" id="prescription-refill" name="prescription-refill" checked>
                                <label for="prescription-refill">Prescription Refill Reminders</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" id="medical-updates" name="medical-updates" checked>
                                <label for="medical-updates">Medical Record Updates</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" id="billing-notifications" name="billing-notifications" checked>
                                <label for="billing-notifications">Billing Notifications</label>
                            </div>
                        </div>
                        <div class="settings-section">
                            <h3>SMS Notifications</h3>
                            <div class="form-check">
                                <input type="checkbox" id="sms-appointment" name="sms-appointment" checked>
                                <label for="sms-appointment">Appointment Reminders</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" id="sms-prescription" name="sms-prescription">
                                <label for="sms-prescription">Prescription Refill Reminders</label>
                            </div>
                        </div>
                        <div class="settings-actions">
                ...
                <div class="settings-container">
                    ...
                    <form action="${pageContext.request.contextPath}/patient/settings" method="post">
                        <div class="form-check">
                            <input type="checkbox" id="share-data" name="share-data" checked>
                            <label for="share-data">Share my data with healthcare providers for better care coordination</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" id="research" name="research">
                            <label for="research">Allow my anonymized data to be used for medical research</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" id="marketing" name="marketing">
                            <label for="marketing">Receive marketing communications about new services</label>
                        </div>
                        <div class="settings-actions">
