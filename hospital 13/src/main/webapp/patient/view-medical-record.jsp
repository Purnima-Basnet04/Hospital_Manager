...
<head>
    ...
    <title>Medical Record Details - LifeCare Medical Center</title>
    ...
    <style>
        ...
        * {
        ...
        .diagnosis-section, .treatment-section, .notes-section {
            margin-top: 20px;
            padding-top: 20px;
            border-top: 1px solid #e9ecef;
        }

        .diagnosis-section h3, .treatment-section h3, .notes-section h3 {
            font-size: 16px;
            color: #333;
            margin-bottom: 10px;
        }

        .diagnosis-section p, .treatment-section p, .notes-section p {
            color: #333;
            font-size: 16px;
            line-height: 1.6;
        ...
        <div class="dashboard-container">
            ...
            <div class="main-content">
                ...
                <div class="welcome-header">
                    ...
                    <p>View detailed information about your medical record.</p>
                </div>
                ...
                <div class="record-details">
                    ...
                    <c:if test="${empty medicalRecord}">
                        ...
                        <a href="medical-records" class="btn">Back to Medical Records</a>
                    </c:if>
                    ...
                    <c:if test="${not empty medicalRecord}">
                        <div class="record-info">
                            <div class="info-group">
                                ...
                                <p>MR${medicalRecord.id}</p>
                            </div>
                            <div class="info-group">
                                <label>Date</label>
                                <p>
                                    <c:if test="${not empty medicalRecord.recordDate}">
                        ...
                        <div class="record-actions">
                            <a href="medical-records" class="btn btn-outline-primary"><i class="fas fa-arrow-left"></i> Back to Medical Records</a>
                            <!-- Removed appointment link as appointmentId is not available in the MedicalRecord class -->
                        </div>
                    </c:if>
                </div>
            </div>
