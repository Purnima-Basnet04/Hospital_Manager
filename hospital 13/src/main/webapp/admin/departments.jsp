        ...
        <div class="admin-content">
            <div class="admin-header">
                <div class="admin-header-left">
                    <h1>Departments</h1>
                    <p>Manage all departments in the hospital</p>
                </div>
                <div class="admin-header-right">
                    <a href="<%= request.getContextPath() %>/admin/departments/add" class="btn"><i class="fas fa-plus"></i> Add New Department</a>
                </div>
            </div>
            ...
            <div class="departments-grid">
                ...
                <div class="department-card">
                    <div class="department-image">
                        ...
                        <% } else { %>
                            <img src="https://via.placeholder.com/300x180?text=<%= dept.getName() %>" alt="<%= dept.getName() %>">
                        <% } %>
                    </div>
                    <div class="department-content">
                        ...
                        <div class="department-actions">
                            <a href="<%= request.getContextPath() %>/admin/departments/edit?id=<%= dept.getId() %>" class="btn btn-sm btn-success">Edit</a>
                            <a href="<%= request.getContextPath() %>/admin/departments/view?id=<%= dept.getId() %>" class="btn btn-sm">View</a>
                            <a href="#" onclick="confirmDelete(<%= dept.getId() %>)" class="btn btn-sm btn-danger">Delete</a>
                        </div>
                    </div>
                </div>
                <% }
