                ...
                <div class="form-container">
                    <form action="<%= request.getContextPath() %>/admin/departments/*" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control" value="<%= department.getName() %>" required>
                        </div>
                        
                        <div class="form-group">
                            <label for="description">Description *</label>
                            <textarea id="description" name="description" class="form-control" required><%= department.getDescription() %></textarea>
                        </div>
                        
                        <div class="form-group">
                            <label for="imageUrl">Image URL</label>
                            <input type="text" id="imageUrl" name="imageUrl" class="form-control" value="<%= department.getImageUrl() != null ? department.getImageUrl() : "" %>" placeholder="https://example.com/image.jpg">
                            <small>Enter a URL for the department image. Leave blank to use a default image.</small>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-col">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="building" name="building" class="form-control" value="<%= department.getBuilding() %>" required>
                                </div>
                            </div>
                            <div class="form-col">
                                <div class="form-group">
                                    <label for="floor">Floor *</label>
                                    <input type="number" id="floor" name="floor" class="form-control" min="0" value="<%= department.getFloor() %>" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="specialistsCount" name="specialistsCount" class="form-control" min="0" value="<%= department.getSpecialistsCount() %>">
                        </div>
                        
                        <div class="form-actions">
                            <a href="departments.jsp" class="btn btn-outline">Cancel</a>
