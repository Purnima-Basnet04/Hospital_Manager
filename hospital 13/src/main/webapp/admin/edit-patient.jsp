...
<%
    ...
    String dateOfBirth = patient.getDateOfBirth() != null ? dateFormat.format(patient.getDateOfBirth()) : "";
%>
<!DOCTYPE html>
<html>
<head>
                ...
                <form action="<%= request.getContextPath() %>/admin/patients/*" method="post">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control" value="<%= patient.getName() != null ? patient.getName() : "" %>" required>
                        </div>
                        <div class="form-group">
                            <label for="username">Username *</label>
                            <input type="text" id="username" name="username" class="form-control" value="<%= patient.getUsername() != null ? patient.getUsername() : "" %>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="email" id="email" name="email" class="form-control" value="<%= patient.getEmail() != null ? patient.getEmail() : "" %>" required>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" id="emergencyContact" name="emergencyContact" class="form-control" value="<%= patient.getEmergencyContact() != null ? patient.getEmergencyContact() : "" %>">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group" style="flex: 100%;">
                            ...
                            <textarea id="address" name="address" class="form-control"><%= patient.getAddress() != null ? patient.getAddress() : "" %></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group" style="flex: 100%;">
                            ...
                            <textarea id="medicalHistory" name="medicalHistory" class="form-control"><%= patient.getMedicalHistory() != null ? patient.getMedicalHistory() : "" %></textarea>
                        </div>
                    </div>
