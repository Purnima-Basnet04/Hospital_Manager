                ...
                <div class="department-image">
                    <c:choose>
                        <c:when test="${not empty department.imageUrl}">
                            <img src="${pageContext.request.contextPath}${department.imageUrl}" alt="${department.name} Department">
                        </c:when>
                        <c:otherwise>
                            <img src="${pageContext.request.contextPath}/department-image?name=${department.name}" alt="${department.name} Department">
                        </c:otherwise>
                    </c:choose>
                </div>
