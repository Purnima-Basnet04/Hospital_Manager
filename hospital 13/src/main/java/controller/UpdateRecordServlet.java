...
@WebServlet("/doctor/update-record")
public class UpdateRecordServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;
       
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println("UpdateRecordServlet: doPost method called");
        ...
        try {
            ...
            System.out.println("UpdateRecordServlet: Updating medical record ID " + idStr);
            ...
            if (success) {
                System.out.println("UpdateRecordServlet: Medical record updated successfully");
                ...
                System.out.println("UpdateRecordServlet: Failed to update medical record");
                ...
                request.getRequestDispatcher("/doctor/edit-record?id=" + id).forward(request, response);
            }
            
        } catch (NumberFormatException e) {
            System.out.println("UpdateRecordServlet: Invalid ID format: " + e.getMessage());
            request.setAttribute("errorMessage", "Invalid ID format");
            request.getRequestDispatcher("/doctor/medical-records").forward(request, response);
        } catch (ParseException e) {
            System.out.println("UpdateRecordServlet: Invalid date format: " + e.getMessage());
            request.setAttribute("errorMessage", "Invalid date format");
            request.getRequestDispatcher("/doctor/edit-record?id=" + request.getParameter("id")).forward(request, response);
        } catch (Exception e) {
            System.out.println("UpdateRecordServlet: Error updating medical record: " + e.getMessage());
            e.printStackTrace();
