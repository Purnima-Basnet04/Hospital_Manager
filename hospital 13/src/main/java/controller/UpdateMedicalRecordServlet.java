...
public class UpdateMedicalRecordServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println("UpdateMedicalRecordServlet: doPost method called");
        ...
        try {
            ...
            System.out.println("UpdateMedicalRecordServlet: Updating medical record ID " + idStr);
            System.out.println("UpdateMedicalRecordServlet: patientId = " + patientIdStr);
            System.out.println("UpdateMedicalRecordServlet: recordType = " + recordType);
            System.out.println("UpdateMedicalRecordServlet: recordDate = " + recordDateStr);
            System.out.println("UpdateMedicalRecordServlet: status = " + status);
            System.out.println("UpdateMedicalRecordServlet: diagnosis = " + diagnosis);
            System.out.println("UpdateMedicalRecordServlet: symptoms = " + symptoms);
            System.out.println("UpdateMedicalRecordServlet: treatment = " + treatment);
            System.out.println("UpdateMedicalRecordServlet: notes = " + notes);
            System.out.println("UpdateMedicalRecordServlet: prescription = " + prescription);
            ...
            if (idStr == null || idStr.isEmpty() ||
                ...
                request.getRequestDispatcher("/doctor/edit-medical-record?id=" + idStr).forward(request, response);
                return;
            }
            ...
            if (success) {
                System.out.println("UpdateMedicalRecordServlet: Medical record updated successfully");
                ...
                System.out.println("UpdateMedicalRecordServlet: Failed to update medical record");
            ...
            System.out.println("UpdateMedicalRecordServlet: Invalid ID format: " + e.getMessage());
            request.setAttribute("errorMessage", "Invalid ID format");
            request.getRequestDispatcher("/doctor/medical-records").forward(request, response);
        } catch (ParseException e) {
            System.out.println("UpdateMedicalRecordServlet: Invalid date format: " + e.getMessage());
            request.setAttribute("errorMessage", "Invalid date format");
            request.getRequestDispatcher("/doctor/better-edit-form?id=" + request.getParameter("id")).forward(request, response);
        } catch (Exception e) {
            System.out.println("UpdateMedicalRecordServlet: Error updating medical record: " + e.getMessage());
            e.printStackTrace();
