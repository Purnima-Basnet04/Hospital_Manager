...
@WebServlet("/doctor/approve-prescription")
public class ApprovePrescriptionServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            boolean success = prescriptionDAO.updatePrescriptionStatus(prescriptionId, "Completed");

            if (success) {
                response.sendRedirect(request.getContextPath() + "/doctor/view-prescription?id=" + prescriptionId + "&success=approved");
            } else {
            ...
            System.out.println("ApprovePrescriptionServlet: Error approving prescription: " + e.getMessage());
            e.printStackTrace();
